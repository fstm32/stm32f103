...
{ 
  ...
  while(1)
  {
    //Proc2msTask();  //2ms处理任务
    //Proc1SecTask(); //1s处理任务
    GPIO_WriteBit(GPIOC, GPIO_Pin_4, Bit_SET);    //LED1点亮
    GPIO_WriteBit(GPIOC, GPIO_Pin_5, Bit_RESET);  //LED2熄灭    
    DelayNms(1000);
    GPIO_WriteBit(GPIOC, GPIO_Pin_4, Bit_RESET);  //LED1熄灭
    GPIO_WriteBit(GPIOC, GPIO_Pin_5, Bit_SET);    //LED2点亮
    DelayNus(1000000);
